...
Add a useEffect to handle the reduced motion attribute:
...
**Note:** Plans 05-02 and 05-03 add effects for font-size and density. This plan adds the reduced motion effect. Each can be a separate useEffect or combined - the key is that data-reduced-motion is set/removed based on the preference.
