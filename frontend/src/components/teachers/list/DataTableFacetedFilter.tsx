...
interface DataTableFacetedFilterProps<TData, TValue> {
    ...
    // For stage filter - pass stages to look up names
...
export function DataTableFacetedFilter<TData, TValue>({
    ...
    // Auto-derive options from faceted unique values if not provided
    const options = React.useMemo(() => {
        ...
        return derivedOptions.sort((a, b) => a.label.localeCompare(b.label));
    }, [facets, providedOptions, stageMap]);
