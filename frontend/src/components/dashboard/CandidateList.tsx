                ...
                <ScrollArea className="h-full">
                    {!hasFilters ? (
                        <div className="flex flex-col items-center justify-center h-[500px] text-slate-400 p-6 text-center space-y-4">
                            ...
                            <div>
                                <p className="font-medium text-slate-600">Ready to Search</p>
                        ...
                        <div className="py-2">
                            {candidates.map((candidate) => (
                                <div
                                    key={candidate._id}
                                    className="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-50 cursor-pointer transition-colors group mx-2 my-1"
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h4 className="font-medium text-sm text-slate-900 group-hover:text-blue-600 truncate">
                                            {candidate.firstName} {candidate.lastName}
                                        </h4>
                                        <div className="flex items-center gap-2 mt-1">
                                            <Badge variant="outline" className="text-[10px] px-1 py-0 h-5 border-slate-200 text-slate-500 font-normal">
