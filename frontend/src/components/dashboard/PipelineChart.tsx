    ...
    return (
        <Card className="col-span-1 min-w-0 border-none shadow-none">
            <CardHeader className="px-0 pt-0">
                <CardTitle className="text-lg font-semibold text-slate-800 font-heading">Recruitment Pipeline</CardTitle>
            </CardHeader>
                    ...
                    <ResponsiveContainer width="100%" height="100%" minWidth={0}>
                        <BarChart data={data} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                            ...
                            <Bar dataKey="value" radius={[0, 6, 6, 0]} barSize={28} animationDuration={300}>
                                <LabelList dataKey="value" position="right" fontSize={14} fill="#64748b" fontWeight={600} />
