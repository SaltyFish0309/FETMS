...
const translations: Record<string, string> = {
  ...
  'email:compose.steps.next': 'Next',
  'email:compose.steps.back': 'Back',
  'email:compose.recipients.title': 'Review Recipients',
  'email:compose.recipients.remove': 'Remove',
  'email:compose.recipients.empty': 'No recipients selected',
  'email:compose.template.title': 'Select Template',
  'email:compose.template.placeholder': 'Select a template...',
  'email:compose.template.subject': 'Subject',
  'email:compose.template.body': 'Body Preview',
  'email:compose.preview.title': 'Preview & Send',
  'email:compose.preview.prev': 'Previous',
  'email:compose.preview.next': 'Next',
  'email:compose.preview.of': 'of',
  'email:compose.preview.send': 'Send',
  'email:compose.preview.sending': 'Sending...',
  'email:compose.result.title': 'Email Sent',
  'email:compose.result.summary': '{{sent}} sent, {{failed}} failed',
  'email:compose.errors.sendFailed': 'Failed to send emails',
